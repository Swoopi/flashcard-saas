...
import { AppBar, Toolbar, Typography, Container, Button, Grid, Box } from "@mui/material";
  ...
  return (
    <Container maxWidth="100vw">
      ...
      <Box sx={{
        ...
        <Typography variant ="h5" gutterBottom> The easy way to make flashcards from your text</Typography>
